...
type Toolkit struct {
	...
	// It is up to the scheduler to know which sources' events need to be watched.
	Sources map[string]source.Source

	// Destinations is the collection of destinations registered in the Blacksmith
	// application. It is up to the scheduler to know which destinations' events need
	// to be resolved.
	...
	// can use it to subscribe to events in realtime using the pubsub Subscriber.
